...
class UserTest {
    ...
    void 유저_생성_실패__이메일_형식위반() {
        ...
        CustomExceptionTest.assertThatCustomException(ExceptionCode.FAIL_EMAIL_REQUEST).isThrownBy(() -> new User("loginId","asdf1234","이름","test@testcom","19950128","01012345678","남"));
